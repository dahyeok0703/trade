...
export function Sidebar({ workspaceName }: { workspaceName: string }) {
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r bg-card lg:flex lg:sticky lg:top-0 lg:h-screen print:hidden">
      ...
      <div className="border-b px-4 py-3">
        <p className="truncate text-xs text-muted-foreground">회사</p>
